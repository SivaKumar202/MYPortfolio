...
function Navbar() {
  return (
    <div className="max-w-7xl mt-9 mx-auto flex justify-around items-center ">
      ...
      <a
        ...
        className="border-2 rounded-3xl px-5 py-3 border-[#C68313] hover:bg-white hover:text-[#FC530A] transition duration-300"
      >
